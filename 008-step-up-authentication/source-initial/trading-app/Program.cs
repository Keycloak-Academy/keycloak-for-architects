...
.AddOpenIdConnect(o =>
{
    ...
    o.Events = new OpenIdConnectEvents
    {
        ...
        // TODO Lab 7: Add OnRedirectToIdentityProvider to inject acr_values=gold
        // when the authorization challenge is triggered by the "AcrGold" policy.
        // Hint: check ctx.Properties.Items[".policy"] and call
        // ctx.ProtocolMessage.SetParameter("acr_values", "gold").
    };
});

// TODO Lab 7: Add an authorization policy named "AcrGold" that requires
// the "acr" claim to contain the value "gold".
// builder.Services.AddAuthorization(o => { o.AddPolicy("AcrGold", ...); });
